  ...
  if (millis() - lastPrint > 2000) {
    ...
    if (wifi.isStaConnected()) {
      ...
      if (wifi.getStaConnectionInfo(info)) {
        ...
        Serial.print("RSSI: ");    Serial.println(info.rssi);
        Serial.print("Channel: "); Serial.println(info.channel);
        Serial.print("IP: ");      Serial.println(info.localIp);
        Serial.print("GW: ");      Serial.println(info.gateway);
        Serial.print("Mask: ");    Serial.println(info.subnet);
        Serial.println("==================");
      }
    }
  }
